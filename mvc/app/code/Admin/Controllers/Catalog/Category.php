...
class Admin_Controllers_Catalog_Category
{
    ...
    public function newAction()
    {
        ...
        $new = Sdp::getBlock("admin/category_new");
    ...
    {
        $root = Sdp::getBlock('page/root');
        $edit = Sdp::getBlock("admin/category_edit");
    ...
    {
        $root = Sdp::getBlock('page/root');
        $delete = Sdp::getBlock("admin/category_delete");
    ...
    {
        $root = Sdp::getBlock('page/root');
        $list = Sdp::getBlock("admin/category_list");
