            ...
            <div class="thumbnail-gallery">
                ...
                foreach ($productImages as $index => $img):
                    ...
                    <img class="product-thumbnail <?php echo $index === 0 ? 'active' : ''; ?>"
                        src="<?php echo htmlspecialchars($img); ?>" data-image="<?php echo htmlspecialchars($img); ?>"
                        alt="Product image <?php echo $index + 1; ?>" style="cursor: pointer; border-radius: 8px;">
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="product-info">
            ...
            <div class="price-section">
                ...
                <span class="original-price">
                    <?php echo format_price($product['originalPrice']); ?>
                </span>
                <span class="discount">
                    <?php
            ...
            <form method="POST" action="cart" class="add-to-cart-form" onsubmit="return validateQuantity(this)">
